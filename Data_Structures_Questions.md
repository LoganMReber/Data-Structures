...
10. What is the runtime complexity of `DoublyLinkedList.delete`? O(1)
    ...
    Linked list delete is almost always better. Splice ranges from O(1) to O(n) where delete has a constant of O(1). If splice only removes the last element it is slightly faster.
